...
-- Run after init.sql: psql -U pricewise -d pricewise -f seed.sql
-- ============================================

-- ============================================
-- 1. DEFAULT ADMIN USER
-- Email: admin@pricewise.ng
-- Password: pricewise2025
-- Hash generated with bcrypt (12 rounds)
-- Change this password immediately in production!
-- ============================================
INSERT INTO admin_users (email, password_hash) VALUES
  ('admin@pricewise.ng', '$2b$12$LJ3m4ys3Lk0TSwHgFnOPxOJxGdJPy/GKBqbVfNqJ9XZP0z1tYhkZi')
...
-- Refresh materialized views (will be empty but creates the structure)
